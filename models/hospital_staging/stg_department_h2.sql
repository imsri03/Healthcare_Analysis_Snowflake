-- This model creates a staging view for the 'DEPARTMENT_H2' source table.
-- It corrects the head_doctor_id prefix and removes duplicate rows.
...
WITH source_data AS (
    ...
    SELECT * FROM "HOSPITAL_DATA_DB"."HOSPITAL_BRONZE"."DEPARTMENT_H2"
...
renamed_and_cleaned AS (
    ...
    SELECT
        ...
        "NAME" AS name,
        "FLOOR" AS floor,
        -- THIS IS THE FIX: Replacing the incorrect 'H1-' prefix with 'H2-'.
        REPLACE("HEAD_DOCTOR_ID", 'H1-', 'H2-') AS head_doctor_id,
